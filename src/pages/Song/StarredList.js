...
function StarredList() {
    ...
    return (<>
      <div className="px-6 grid grid-cols-1 md:grid-cols-1 xl:grid-cols-3 pt-[70px] gap-[40px]">
        <div class="col-span-1 md:col-span-1 xl:col-span-2">
          <div className="flex flex-col gap-[24px]">
            ...
            <table className="w-full table-auto text-sm text-left rtl:text-right text-gray-500 dark:text-gray-800">
