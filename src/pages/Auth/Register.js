...
function Register() {
    ...
    return (<>
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 g bg-cover bg-no-repeat bg-center h-screen " style={{
            backgroundImage: 'url("/demo/assets/register.png")',
                ...
                <div style={{maxWidth: "468px", maxHeight: '627px', margin: '0 auto', backdropFilter: 'blur(10px)'}} className="w-full bg-secondary-700 p-4 sm:p-6 md:p-8 gap-[20px] bg-opacity-85 rounded-5 shadow-bottom_1 flex justify-start flex-col items-center">                    
                    ...
                    <div className="relative z-20 flex flex-col justify-start w-full gap-[5px]">
                        <div className="flex flex-row justify-start items-center">
                            <p className="font-plus text-white font-light text-14 leading-20">User</p>
                    ...
                    <div className="flex flex-col justify-start w-full gap-[5px]">
                        ...
                        <input type="text" className="bg-primary-700 opacity-100 py-2 px-4 rounded-3 text-white font-plus font-normal outline-none border-transparent focus:border-transparent focus:ring-0" style={{height: '36px'}}></input>
                    </div>
                    <div className="flex flex-col justify-start w-full gap-[5px]">
                        <div className="flex flex-row justify-start items-center">
                    ...
                    <div className="flex flex-col justify-start w-full gap-[5px]">
                        <div className="flex flex-row justify-start items-center pl-2">
                            ...
                            <label className="font-plus text-white font-light text-14 leading-20 pl-2 ">I accept the terms and conditions</label>
                        </div>
                    </div>
                    <div className="flex flex-col justify-center items-center w-full gap-[5px] w-[231px]">
                        <a className="fill-btn text-12 px-4 py-2 text-white font-medium bg-darkblue-600 rounded-8 w-full flex flex-row justify-center gap-45 items-center" 
                            ...
                            onClick={() => history.push("/app/home")}>Continue
                    ...
                    <div className="flex flex-col justify-center items-center w-full gap-[5px]">
                        <p className="font-plus text-white font-normal text-16 leading-20">Do you already have an account?</p>
                    </div>
                    <div className="flex flex-col justify-center items-center w-full">
                        <p className="font-plus cursor-pointer text-darkblue-400 font-bold text-14 leading-20" onClick={() => history.push("/auth/login")}>Log in</p>
                    </div>
                </div>
            </div>
        </div>
